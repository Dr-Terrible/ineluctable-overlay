...
EDOC_COMMIT="9b5a10d696c1f22c9ffee8bae54c31cd900b3754"
EEXAMPLE_COMMIT="f6e45d092115f38755bf4df48440459893d1ca38"
...
KEYWORDS="~amd64 ~x86"
IUSE_MODULES="server"
IUSE="+etc python squirrel +tools lua rfd +vorbis +minizip +opengl +theora +truetype +speex +png +jpeg +webp +dds +pvr +musepack doc examples ssl +pulseaudio +xml +3d squish"
