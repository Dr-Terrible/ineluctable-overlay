...
HOMEPAGE="https://wiki.gnome.org/Apps/Terminal/VTE termite? ( https://github.com/thestinger/vte-ng )"

LICENSE="LGPL-2+"
SLOT="2.91"
IUSE="+crypt debug glade +introspection +termite vala vanilla"
