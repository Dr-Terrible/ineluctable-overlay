...
inherit python-single-r1 waf-utils multilib-minimal systemd
...
LICENSE="GPL-2"
SLOT="2"
IUSE="alsa +classic dbus doc ieee1394 libsamplerate metadata opus pam readline sndfile systemd"
