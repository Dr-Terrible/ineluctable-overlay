...
#	https://github.com/rust-lang/mdBook/archive/eaa69142059c04ca14aa23ffeb1fe1469663403f.zip -> ${P}-docs.zip"
RESTRICT="mirror"
...
src_install() {
	...
	if use doc; then
		"${D}"/usr/bin/mdbook build "${WORKDIR}"/mdBook-${PV}/guide --dest-dir "${D}"/usr/share/doc/${PF}/html || die
	fi
}
