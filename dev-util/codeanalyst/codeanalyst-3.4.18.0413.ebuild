...
HOMEPAGE="http://developer.amd.com/cpu/CodeAnalyst"s
SRC_URI="CodeAnalyst-3_4_18_0413-Public.tar.gz"
RESTRICT="fetch"
...
pkg_nofetch() {
	elog "Please visit http://developer.amd.com/amd-license-agreement/?f=${SRC_URI}"
	elog "and place ${SRC_URI} in ${DISTDIR}"
}
