...
BDEPEND="$(python_gen_any_dep 'dev-python/setuptools[${PYTHON_USEDEP}]')"
DEPEND="
	app-text/asciidoc
	test? ( $(python_gen_any_dep 'dev-python/pytest[${PYTHON_USEDEP}]') )"
RDEPEND="$(python_gen_any_dep '
	...
	>=dev-python/PyQt5-5.12.2[${PYTHON_USEDEP},declarative,multimedia,gui,network,opengl,printsupport,sql,widgets]
